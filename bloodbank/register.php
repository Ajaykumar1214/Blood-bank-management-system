    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container active" id="hospitals">
        ...
        <form action="file/hospitalReg.php" method="post" enctype="multipart/form-data">
          <input type="text" name="hname" placeholder="Hospitals Name" class="form-control mb-3" required>
          <input type="text" name="hcity" placeholder="Hospitals City" class="form-control mb-3" required>
          <input type="tel" name="hphone" placeholder="Hospitals Phone Number" class="form-control mb-3" required pattern="[0,6-9]{1}[0-9]{9,11}" title="Password must have start from 0,6,7,8 or 9 and must have 10 to 12 digit">
          <input type="email" name="hemail" placeholder="Hospitals Email" class="form-control mb-3" required>
          <input type="password" name="hpassword" placeholder="Hospitals Password" class="form-control mb-3" required minlength="6">
